                    ...
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td class="header" align="center">
                                <img src="http://Daniel.kyakabi.com/profile/ibd.png" alt="Daniel Liu Portfolio" width="564" style="display: block; max-width: 100%;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="footer">
                                <p><strong>Daniel Liu</strong><br>
                                Software Developer based in California, US<br>
                                ehhsgd667@gmail.com | +12028387418</p>
                                ...
                                <div class="social-icons">
                                    ...
                                    <a href="https://github.com/danielliu" target="_blank">
...
<body style="margin: 0; padding: 0; background-color: #f1f5f8;">
                    ...
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td class="content">
                                ...
                                <p class="text-center" style="text-align: center;">
                                    Daniel Liu - Software Developer<br>
                                ...
                                <ul>
                                    <li>View my <a href="http://localhost:3000/projects">recent projects</a></li>
                                    <li>Check out my <a href="http://localhost:3000/">technical skills</a></li>
                                    <li>See my professional <a href="http://localhost:3000/certificates">certifications</a></li>
                                </ul>
                        ...
                        <tr>
                            <td class="footer">
                                ...
                                <p>ehhsgd667@gmail.com | +12028387418</p>
                                ...
                                <p style="font-size: 10px;">
                                    &copy; ${currentYear} Daniel Liu. All rights reserved.
                                </p>
                            </td>
                        </tr>
                    </table>
    ...
    await transporter.sendMail({
      from: `"Daniel Liu" <${process.env.FROM_EMAIL}>`,
      to: email,
      subject: 'Message Received - Daniel Liu',
